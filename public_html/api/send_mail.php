      ...
      <tr>
        <td>
          <div class="m_786297689978477055helloUser" style="font-size:30px;font-family:Lato,sans-serif;margin-top:20px;color:#282c3f;font-stretch:normal;font-style:normal;line-height:normal;letter-spacing:normal">
            Hello <span id="m_786297689978477055ReceiverName" style="font-weight:bold">'.$fullName.'</span>
                      </div>
        </td>
      </tr>
    </tbody></table>
                              ...
                              <tr style="margin:0;padding:0">
                                 <td style="padding:0% 3% 0% 0%" colspan="2">
                                     <p class="m_786297689978477055statusText" style="margin:0;font-family:Lato,sans-serif;color:white;padding:0;float:left;width:100%;font-size:30px;line-height:normal;margin-bottom:8px">
                                       Thank you for booking <strong style="font-family:Lato,sans-serif;letter-spacing:0.5px;font-weight:bold;">'.$tourPackage.'<br/></strong>
                                    </p>
                              ...
                              <tr style="margin:0;padding:0">
                                 <td style="padding:0% 3% 0% 0%" colspan="2">
                                    <p class="m_786297689978477055subStatusText" style="line-height:1.38;padding:0;float:left;width:100%;font-size:16px;opacity:0.9;font-family:Lato,sans-serif;margin-top:10px">
                                        Our executive will be calling your registered phone number shortly to confirm the booking.
                                    </p>
                                 </td>
                              </tr>
                              <tr style="margin:0;padding:0">
                                                                  <td style="padding:0% 3% 0% 0%" colspan="2">
                                  <a class="m_786297689978477055statusCTA" style="text-decoration:none;float:left;background:white;padding:10px 30px 12px 24px;margin-top:10px;margin-bottom:10px;border-radius:4px;text-transform:uppercase;font-family:Lato,sans-serif;font-size:4px;line-height:4px" href="tel://9863789990" target="_blank">
